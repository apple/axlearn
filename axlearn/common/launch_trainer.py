...
flags.DEFINE_bool(
    "enable_ml_diagnostics",
    False,
    "Whether to enable Google Cloud ML Diagnostics and automated profiler capture.",
)
flags.DEFINE_string(
    "ml_diagnostics_run_name",
    None,
    "Mandatory ML Diagnostics run name if --enable_ml_diagnostics is used.",
)
flags.DEFINE_string(
...
def get_trainer_config(
    ...
    *,
    ...
    trainer_config.ml_diagnostics = MLDiagnosticsConfig(
        enable=flag_values.enable_ml_diagnostics,
        run_name=flag_values.ml_diagnostics_run_name,
