    ...
    * cost_analysis:
    ...
    if cost_stats:
        ...
        try:
            ...
            # IndexError, KeyError: guard cost_stats[0]
            # AttributeError, TypeError: guard cost_stats.get('xxx')
            analysis_results += f"{cost_stats}\n"
            logging.warning("Attempt to parse cost_stats=%s failed: %s", cost_stats, e)
