...
class SpmdTrainer(Module):
    ...
    def __init__(
        ...
        *,
        ...
        with self._record_event(measurement.EventType.ACCELERATOR_INIT):
    ...
    def _record_event(self, event: measurement.EventType, *args, **kwargs):
    ...
    def run(
        ...
        with (
            ...
            with self.checkpointer:
                ...
                while True:
                    try:
                        with self._record_event(measurement.EventType.DATA_LOADING):
                        ...
                        with self._record_event(measurement.EventType.STEP, self._step):
    ...
    def _get_compiled_train_step_fn(
        ...
        if not with_xsc:
            with self._record_event(
                measurement.EventType.CUSTOM_BADPUT_EVENT,
    ...
    def _run_eval(
        ...
        *,
        ...
        with self._record_event(
            measurement.EventType.CUSTOM_BADPUT_EVENT, custom_badput_event_type="EVAL"
        ):
            evaler_summaries = {}
