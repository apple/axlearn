...
class SpmdTrainer(Module):
    ...
    def __init__(
        ...
        *,
        ...
        from axlearn.common.managed_mldiagnostics import is_ml_diagnostics_enabled
        self._enable_ml_diagnostics: bool = is_ml_diagnostics_enabled(cfg.ml_diagnostics)
        ...
        with self.mesh():
            ...
            if self._enable_ml_diagnostics:
