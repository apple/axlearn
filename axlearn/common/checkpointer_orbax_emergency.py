...
def _initialize_runtime_to_distributed_ids(timeout: int):
    ...
    """
    # pylint: disable=protected-access
    client = multihost_src.get_jax_distributed_client()
...
def _init_consistent_proc_ids(
    ...
    **setup_kwargs,
    ...
    if jax_backend == "tpu":
        ...
        # num_proc_per_slice + worker_id`. After id assignment, the address of process that's
        # assigned with id=0 will be broadcasted to every worker.
        ...
        # Coordinator port for TPU is hardcoded.
        # Reference:
