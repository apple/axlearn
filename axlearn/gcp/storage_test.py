...
Example usage:
    ...
    python3 -m axlearn.gcp.storage_test --project=my-project
...
from axlearn.gcp.storage import blob_exists, delete_blob, list_blobs, upload_blob
from axlearn.gcp.utils import common_flags
