...
- [2024/06/28] Our Mixture-of-Experts (MoE) implementation and sharding strategy are released [[code]](https://github.com/apple/axlearn/blob/main/axlearn/common/mixture_of_experts.py). We also released a [tech report](https://arxiv.org/abs/2405.15052) that thoroughly studies the MoE and dense LLM performance comparisons across a wide range of model scales.
